...
import { TLFlexShape } from '@tldraw/editor';
import { TLFlexShapeProps } from '@tldraw/editor';
...
// @public (undocumented)
export const defaultShapeTools: readonly [typeof TextShapeTool, typeof DrawShapeTool, typeof GeoShapeTool, typeof NoteShapeTool, typeof LineShapeTool, typeof FrameShapeTool, typeof FlexShapeTool, typeof ArrowShapeTool, typeof HighlightShapeTool];

// @public (undocumented)
export const defaultShapeUtils: readonly [typeof TextShapeUtil, typeof BookmarkShapeUtil, typeof DrawShapeUtil, typeof GeoShapeUtil, typeof NoteShapeUtil, typeof LineShapeUtil, typeof FlexShapeUtil, typeof FrameShapeUtil, typeof ArrowShapeUtil, typeof HighlightShapeUtil, typeof EmbedShapeUtil, typeof ImageShapeUtil, typeof VideoShapeUtil];
...
export class FlexShapeUtil extends BaseFrameLikeShapeUtil<TLFlexShape> {
    ...
    // (undocumented)
    component(shape: TLFlexShape): JSX.Element;
    // (undocumented)
    getDefaultProps(): TLFlexShape['props'];
    // (undocumented)
    getGeometry(shape: TLFlexShape): Group2d;
    // (undocumented)
    getIndicatorPath(shape: TLFlexShape): Path2D;
    // (undocumented)
    getInterpolatedProps(startShape: TLFlexShape, endShape: TLFlexShape, t: number): TLFlexShapeProps;
    // (undocumented)
    static migrations: TLPropsMigrations;
    // (undocumented)
    onChildrenChange(shape: TLFlexShape): TLShapePartial[] | void;
    // (undocumented)
    onResize(shape: TLFlexShape, info: Parameters<typeof resizeBox<TLFlexShape>>[1]): TLFlexShape;
    // (undocumented)
    static props: RecordProps<TLFlexShape>;
    // (undocumented)
    toSvg(shape: TLFlexShape): JSX.Element;
    // (undocumented)
    static type: "flex";
}

...
export const DEFAULT_TRANSLATION = {
	...
	'flex-align-content-style.flex-start': 'Start',
	'flex-align-content-style.center': 'Center',
	'flex-align-content-style.flex-end': 'End',
	'flex-align-content-style.stretch': 'Stretch',
	'flex-align-content-style.space-between': 'Space between',
	'flex-align-content-style.space-around': 'Space around',
	'flex-align-items-style.flex-start': 'Start',
	'flex-align-items-style.center': 'Center',
	'flex-align-items-style.flex-end': 'End',
	'flex-align-items-style.stretch': 'Stretch',
	'flex-align-self-style.auto': 'Auto',
	'flex-align-self-style.flex-start': 'Start',
	'flex-align-self-style.center': 'Center',
	'flex-align-self-style.flex-end': 'End',
	'flex-align-self-style.stretch': 'Stretch',
	'flex-basis-style.auto': 'Auto',
	'flex-basis-style.zero': 'Zero',
	'flex-basis-style.s': 'Small',
	'flex-basis-style.m': 'Medium',
	'flex-basis-style.l': 'Large',
	'flex-direction-style.row': 'Row',
	'flex-direction-style.column': 'Column',
	'flex-grow-style.0': 'Off',
	'flex-grow-style.1': 'On',
	'flex-justify-content-style.flex-start': 'Start',
	'flex-justify-content-style.center': 'Center',
	'flex-justify-content-style.flex-end': 'End',
	'flex-justify-content-style.space-between': 'Space between',
	'flex-justify-content-style.space-around': 'Space around',
	'flex-justify-content-style.space-evenly': 'Space evenly',
	'flex-order-style.-1': 'Before',
	'flex-order-style.0': 'Default',
	'flex-order-style.1': 'After',
	'flex-shrink-style.0': 'Off',
	'flex-shrink-style.1': 'On',
	'flex-space-style.none': 'None',
	'flex-space-style.xs': 'Extra small',
	'flex-space-style.s': 'Small',
	'flex-space-style.m': 'Medium',
	'flex-space-style.l': 'Large',
	'flex-space-style.xl': 'Extra large',
	'flex-wrap-style.nowrap': 'No wrap',
	'flex-wrap-style.wrap': 'Wrap',
	...
	'style-panel.flex-align-content': 'Align content',
	'style-panel.flex-align-items': 'Align items',
	'style-panel.flex-align-self': 'Align self',
	'style-panel.flex-basis': 'Basis',
	'style-panel.flex-direction': 'Direction',
	'style-panel.flex-gap': 'Gap',
	'style-panel.flex-grow': 'Grow',
	'style-panel.flex-item': 'Flex item',
	'style-panel.flex-justify-content': 'Justify',
	'style-panel.flex-order': 'Order',
	'style-panel.flex-padding': 'Padding',
	'style-panel.flex-shrink': 'Shrink',
	'style-panel.flex-wrap': 'Wrap',

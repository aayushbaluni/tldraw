...
export type TLUiTranslationKey =
	...
	| 'dash-style.draw'
	| 'dash-style.solid'
	| 'flex-align-content-style.center'
	| 'flex-align-content-style.flex-end'
	| 'flex-align-content-style.flex-start'
	| 'flex-align-content-style.space-around'
	| 'flex-align-content-style.space-between'
	| 'flex-align-content-style.stretch'
	| 'flex-align-items-style.center'
	| 'flex-align-items-style.flex-end'
	| 'flex-align-items-style.flex-start'
	| 'flex-align-items-style.stretch'
	| 'flex-align-self-style.auto'
	| 'flex-align-self-style.center'
	| 'flex-align-self-style.flex-end'
	| 'flex-align-self-style.flex-start'
	| 'flex-align-self-style.stretch'
	| 'flex-basis-style.auto'
	| 'flex-basis-style.l'
	| 'flex-basis-style.m'
	| 'flex-basis-style.s'
	| 'flex-basis-style.zero'
	| 'flex-direction-style.column'
	| 'flex-direction-style.row'
	| 'flex-grow-style.0'
	| 'flex-grow-style.1'
	| 'flex-justify-content-style.center'
	| 'flex-justify-content-style.flex-end'
	| 'flex-justify-content-style.flex-start'
	| 'flex-justify-content-style.space-around'
	| 'flex-justify-content-style.space-between'
	| 'flex-justify-content-style.space-evenly'
	| 'flex-order-style.-1'
	| 'flex-order-style.0'
	| 'flex-order-style.1'
	| 'flex-shrink-style.0'
	...
	| 'flex-space-style.l'
	| 'flex-space-style.m'
	| 'flex-space-style.none'
	| 'flex-space-style.s'
	| 'flex-space-style.xl'
	| 'flex-space-style.xs'
	| 'flex-wrap-style.nowrap'
	...
	| 'style-panel.dash'
	| 'style-panel.fill'
	| 'style-panel.flex-align-content'
	| 'style-panel.flex-align-items'
	| 'style-panel.flex-align-self'
	| 'style-panel.flex-basis'
	| 'style-panel.flex-direction'
	| 'style-panel.flex-gap'
	| 'style-panel.flex-grow'
	| 'style-panel.flex-item'
	| 'style-panel.flex-justify-content'
	| 'style-panel.flex-order'
	| 'style-panel.flex-padding'
	| 'style-panel.flex-shrink'
	| 'style-panel.flex-wrap'
	| 'style-panel.font'
	| 'style-panel.geo'
	| 'style-panel.mixed'
	| 'style-panel.opacity'
